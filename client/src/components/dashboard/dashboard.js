...
import PostPreview from "./PostProfilePreview";
import DashboardHeader from "./ProfileHeader";
      ...
      {tab === "POSTS" && (
        <>
          {dashboard?.posts?.length === 0 ? (
            ...
            <PostPreview posts={dashboard?.posts} />
          )}
        </>
      )}
      ...
      {tab === "SAVED" && (
        <>
          {dashboard?.savedPosts?.length === 0 ? (
            ...
            <PostPreview posts={dashboard?.savedPosts} />
          )}
        </>
      )}
    </Wrapper>
